# New Earth Command Dashboard Project Map
...
## Feature Inventory
| Feature | Path | Size Signal |
| --- | --- | --- |
| Assets | `lib/features/assets/` | 29 tracked files |
| Business | `lib/features/business/` | 4 tracked files |
| Content | `lib/features/content/` | 4 tracked files |
| Dashboard | `lib/features/dashboard/` | 4 tracked files |
| Inbox | `lib/features/inbox/` | 4 tracked files |
| Journal | `lib/features/journal/` | 4 tracked files |
| Knowledge Library | `lib/features/knowledge_library/` | 2 tracked files |
| Learning | `lib/features/learning/` | 4 tracked files |
| Meeting System | `lib/features/meeting_system/` | 12 tracked files |
| More | `lib/features/more/` | 1 tracked files |
| Planner | `lib/features/planner/` | 3 tracked files |
| Project Intelligence | `lib/features/project_intelligence/` | 7 tracked files |
