...
void main() {
  test('company summary report exports source-linked markdown and backups on overwrite', () async {
    ...
    final secondResult = await service.exportSummaryReport(snapshot: snapshot);
...
CompanyCommandCentreSnapshot _buildSnapshot({
  ...
  return CompanyCommandCentreSnapshot(
    ...
    moduleConfigPath: 'modules/00_COMPANY_COMMAND_CENTRE_OMEGA_MODULE/src/module_shell/module_config.json',
    ...
    auditLogPath: path.join(reportRootPath, 'audit', 'company_command_centre_write_audit.jsonl'),
