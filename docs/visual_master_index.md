...
| Thumbnail | Visual |
| --- | --- |
| [![Voice session state machine](architecture/module_hub/visuals/voice_session_state_machine.png)](architecture/module_hub/visuals/voice_session_state_machine.png) | [Voice session state machine](architecture/module_hub/visuals/voice_session_state_machine.png) |
...
| [![Backup / recovery control flow](../assets/diagrams/backup_recovery_control_flow.png)](../assets/diagrams/backup_recovery_control_flow.png) | [Backup / recovery control flow](../assets/diagrams/backup_recovery_control_flow.png) |
| [![Full repo topology](../assets/diagrams/full_repo_topology.png)](../assets/diagrams/full_repo_topology.png) | [Full repo topology](../assets/diagrams/full_repo_topology.png) |
| [![Shell / module / knowledge / operational layers](../assets/diagrams/shell_module_knowledge_operational_layers.png)](../assets/diagrams/shell_module_knowledge_operational_layers.png) | [Shell / module / knowledge / operational layers](../assets/diagrams/shell_module_knowledge_operational_layers.png) |
| [![Local-first data flow](../assets/diagrams/local_first_data_flow.png)](../assets/diagrams/local_first_data_flow.png) | [Local-first data flow](../assets/diagrams/local_first_data_flow.png) |
| [![Dashboard to vault feedback loop](../assets/diagrams/dashboard_to_vault_feedback_loop.png)](../assets/diagrams/dashboard_to_vault_feedback_loop.png) | [Dashboard to vault feedback loop](../assets/diagrams/dashboard_to_vault_feedback_loop.png) |
| [![Local sync, export, and review paths](architecture/module_hub/visuals/local_sync_export_review_paths.png)](architecture/module_hub/visuals/local_sync_export_review_paths.png) | [Local sync, export, and review paths](architecture/module_hub/visuals/local_sync_export_review_paths.png) |
...
| --- | --- |
| [![Module Hub status matrix](architecture/module_hub/visuals/module_hub_status_matrix.png)](architecture/module_hub/visuals/module_hub_status_matrix.png) | [Module Hub status matrix](architecture/module_hub/visuals/module_hub_status_matrix.png) |
| [![Omega OS integration map](../assets/diagrams/omega_os_integration_map.png)](../assets/diagrams/omega_os_integration_map.png) | [Omega OS integration map](../assets/diagrams/omega_os_integration_map.png) |
| [![Documentation automation flow](roadmap/images/documentation_automation_flow.png)](roadmap/images/documentation_automation_flow.png) | [Documentation automation flow](roadmap/images/documentation_automation_flow.png) |
| [![Release readiness and build proof summary](roadmap/images/release_readiness_build_proof_summary.png)](roadmap/images/release_readiness_build_proof_summary.png) | [Release readiness and build proof summary](roadmap/images/release_readiness_build_proof_summary.png) |
...
| Thumbnail | Visual |
| --- | --- |
| [![AI adapter and safe-assist architecture](../assets/diagrams/ai_adapter_safe_assist_architecture.png)](../assets/diagrams/ai_adapter_safe_assist_architecture.png) | [AI adapter and safe-assist architecture](../assets/diagrams/ai_adapter_safe_assist_architecture.png) |
| [![External integration strategy](../assets/diagrams/external_integration_strategy.png)](../assets/diagrams/external_integration_strategy.png) | [External integration strategy](../assets/diagrams/external_integration_strategy.png) |
| [![Live dock host and multi-window layout](../assets/diagrams/live_dock_host_multi_window_layout.png)](../assets/diagrams/live_dock_host_multi_window_layout.png) | [Live dock host and multi-window layout](../assets/diagrams/live_dock_host_multi_window_layout.png) |
| [![Cross-repo knowledge fabric map](../assets/diagrams/cross_repo_knowledge_fabric_map.png)](../assets/diagrams/cross_repo_knowledge_fabric_map.png) | [Cross-repo knowledge fabric map](../assets/diagrams/cross_repo_knowledge_fabric_map.png) |
| [![Future module onboarding diagram](../assets/diagrams/future_module_onboarding_diagram.png)](../assets/diagrams/future_module_onboarding_diagram.png) | [Future module onboarding diagram](../assets/diagrams/future_module_onboarding_diagram.png) |
