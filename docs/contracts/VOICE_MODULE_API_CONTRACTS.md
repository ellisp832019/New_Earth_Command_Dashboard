...
These contracts describe the local-first voice surfaces used by the dashboard module.

They are intentionally simple and mock-friendly so the app can run without an OpenAI key.
