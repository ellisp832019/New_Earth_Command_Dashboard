...
This folder holds the project planning stack for the New Earth Command Dashboard.

Use this page as the entry point when you want to understand the project at a glance.
...
- [`dashboard_future_roadmap.md`](dashboard_future_roadmap.md)
...
These roadmaps are intended to stay aligned with the FSD and `TASK.md`.

When priorities change:

1. Update the active roadmap.
2. Update `TASK.md` for the next slice.
3. Keep the repo history clean and easy to review.
