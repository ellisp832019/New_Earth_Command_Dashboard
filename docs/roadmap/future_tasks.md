...
This is the next-work backlog from the current state of the app onward.
It focuses on the most useful follow-on improvements after the MVP core.
The same items are also seeded into the app as Planned tasks under the Future Ideas project.
