# Architecture Visual Index

This page is the master index for architecture-related images in the New Earth Command Dashboard repo.
...
- [Database relationship diagram](../assets/diagrams/19_database_relationship_diagram.png)
- [Local-first privacy diagram](../assets/diagrams/30_local_first_privacy_diagram.png)
...
- [Module gallery overview](module_gallery/README.md)

## Knowledge Fabric Sync

- [End-to-end sync architecture](module_hub/visuals/knowledge_fabric_sync_architecture_01_end_to_end.png)
...
- [Dashboard module map](../roadmap/images/dashboard_module_map_v1.png)
...
- [Getting started quick start](../assets/user_guide/35_getting_started_quick_start.png)
- [Dashboard user manual page](../assets/user_guide/36_dashboard_user_manual_page.png)
- [Projects and tasks manual page](../assets/user_guide/37_projects_tasks_user_manual_page.png)
- [Journal and planner manual page](../assets/user_guide/38_journal_planner_user_manual_page.png)

## Notes

- The module hub images live under `docs/architecture/module_hub/visuals/`.
- The module gallery lives under `docs/architecture/module_gallery/` and is the showcase for module posters.
