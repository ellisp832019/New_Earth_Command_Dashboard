...
- [FSD Master Index](fsd/00_master_index.md)
...
- [Knowledge Fabric Sync Architecture](architecture/module_hub/knowledge_fabric_sync_architecture.md)
- [Module Gallery](architecture/module_gallery/README.md)
...
- `fsd/` contains the source specification and build scope.
- `user_guide/` explains how to use the app.
- `developer_guide/` explains how to build and maintain the app.
- `architecture/` records decisions, module hub references, and visual indexes.
...
- `hayley_assets/` holds the asset inventory guides and checklists.
