...
class _AddBusinessOpportunityScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final isEditing = widget.businessId != null;

    return projects.when(
      data: (projectItems) {
        if (!isEditing) {
          return _buildScaffold(projectItems);
        }

        final business = ref.watch(businessItemProvider(widget.businessId!));
          ...
          error: (error, stackTrace) => Scaffold(
            ...
            body: Center(
              child: Padding(
                ...
                child: Text(
                  'Business data could not be loaded for editing.',
  ...
  Scaffold _buildScaffold(List<Project> projectItems) {
    final isEditing = widget.businessId != null;
    return Scaffold(
      appBar: AppBar(title: Text(isEditing ? 'Edit Opportunity' : 'Add Opportunity')),
      body: Form(
        key: _formKey,
        child: ListView(
