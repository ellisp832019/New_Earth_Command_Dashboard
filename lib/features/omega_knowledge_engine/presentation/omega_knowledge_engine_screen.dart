...
class _OmegaKnowledgeEngineScreenState extends State<OmegaKnowledgeEngineScreen>
  ...
  final GlobalKey<OmegaKnowledgeEngineTerminalDockState> _terminalDockKey =
      GlobalKey<OmegaKnowledgeEngineTerminalDockState>();
...
class _OverviewTab extends StatelessWidget {
  ...
  final OmegaKnowledgeEngineService service;
  final GlobalKey<OmegaKnowledgeEngineTerminalDockState> terminalDockKey;
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        OmegaKnowledgeEngineTerminalDock(
          key: terminalDockKey,
          snapshot: snapshot,
          service: service,
