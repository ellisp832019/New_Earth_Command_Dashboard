...
class AddLearningItemScreen extends ConsumerStatefulWidget {
  const AddLearningItemScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return projects.when(
      data: (projectItems) => Scaffold(
        appBar: AppBar(title: const Text('Add Learning Topic')),
        body: Form(
          key: _formKey,
          child: ListView(
            ...
            children: [
              ...
              FilledButton.icon(
                ...
                label: const Text('Create Learning Topic'),
              ),
            ],
          ),
        ),
  ...
  Future<void> _save(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('${learningItem.topic} created.')));
    } finally {
      if (mounted) {
