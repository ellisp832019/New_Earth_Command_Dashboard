...
class AddContentItemScreen extends ConsumerStatefulWidget {
  const AddContentItemScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return projects.when(
      data: (projectItems) => Scaffold(
        appBar: AppBar(title: const Text('Add Content Idea')),
        body: Form(
          key: _formKey,
          child: ListView(
            ...
            children: [
              ...
              FilledButton.icon(
                ...
                label: const Text('Create Content Idea'),
              ),
            ],
          ),
        ),
  ...
  Future<void> _save(BuildContext context) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('${item.title} created.')));
    } finally {
      if (mounted) {
