...
abstract final class AppTheme {
  static ThemeData get light {
    ...
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        backgroundColor: AppColours.surface,
        selectedColor: AppColours.primary.withValues(alpha: 0.16),
        disabledColor: AppColours.surface.withValues(alpha: 0.72),
  ...
  static ThemeData get dark {
    ...
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        backgroundColor: AppColours.darkSurface,
        selectedColor: AppColours.darkPrimary.withValues(alpha: 0.18),
        disabledColor: AppColours.darkSurfaceAlt.withValues(alpha: 0.72),
        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
        labelPadding: const EdgeInsets.symmetric(horizontal: 2),
        side: const BorderSide(color: AppColours.darkOutline),
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(999)),
